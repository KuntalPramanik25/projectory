...
export const KanbanCard = ({ task }: KanbanCardProps) => {
    ...
    return (
        ...
        <div className="bg-white p-2.5 mb-1.5 border rounded-md shadow-sm space-y-3">
            <div className="flex items-start justify-between gap-x-2 px-1.5">
